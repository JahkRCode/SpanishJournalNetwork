...
class ClassifiedsScreen extends Component{
    ...
    articlesByCategory(){
        this.props.getArticles(32).then(()=>{
...
function mapStateToProps(state){
    //console.warn("***** CLS STATE TO PROPS:" + JSON.stringify(state))
    return {
...
export default connect(mapStateToProps, {clearArticles, getArticles})(ClassifiedsScreen);
