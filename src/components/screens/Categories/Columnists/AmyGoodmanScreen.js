...
class AmyGoodmanScreen extends Component{
    static navigationOptions = {
        drawerIcon: (
            <Image
                style={{ width: 25, height: 25 }}
                source={require('./../../../../../assets/images/amygoodman.png')}
            />
        )
    };
    constructor(props) {
    ...
    articlesByCategory(){
        this.props.getArticles(17).then(()=>{
...
function mapStateToProps(state){
    //console.warn("***** AG STATE TO PROPS:" + JSON.stringify(state))
    return {
...
export default connect(mapStateToProps, {clearArticles, getArticles})(AmyGoodmanScreen);
