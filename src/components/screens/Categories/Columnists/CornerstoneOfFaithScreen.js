...
class CornerstoneOfFaithScreen extends Component{
    static navigationOptions = {
        drawerIcon: (
            <Image
                style={{ width: 25, height: 25 }}
                source={require('./../../../../../assets/images/cornerstone.png')}
            />
        )
    };
    constructor(props) {
    ...
    articlesByCategory(){
        this.props.getArticles(19).then(()=>{
...
function mapStateToProps(state){
    //console.warn("***** CoF STATE TO PROPS:" + JSON.stringify(state))
    return {
...
export default connect(mapStateToProps, {clearArticles, getArticles})(CornerstoneOfFaithScreen);
