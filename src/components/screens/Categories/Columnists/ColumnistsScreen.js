...
class ColumnistsScreen extends Component{
    ...
    articlesByCategory(){
        this.props.getArticles(23).then(()=>{
...
function mapStateToProps(state){
    //console.warn("***** COLUMNISTS STATE TO PROPS:" + JSON.stringify(state))
    return {
...
export default connect(mapStateToProps, {clearArticles, getArticles})(ColumnistsScreen);
