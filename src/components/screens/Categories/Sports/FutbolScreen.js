...
class FutbolScreen extends Component{
    ...
    articlesByCategory(){
        this.props.getArticles(62).then(()=>{
...
function mapStateToProps(state){
    //console.warn("***** FUT STATE TO PROPS:" + JSON.stringify(state))
    return {
...
export default connect(mapStateToProps, {clearArticles, getArticles})(FutbolScreen);
