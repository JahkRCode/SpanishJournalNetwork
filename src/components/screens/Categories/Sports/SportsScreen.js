...
function mapStateToProps(state){
    console.warn("***** SPO STATE TO PROPS:" + JSON.stringify(state))
    return {
...
export default connect(mapStateToProps, {clearArticles, getArticles})(SportsScreen);
