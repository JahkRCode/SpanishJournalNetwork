...
class AmericanFootballScreen extends Component{
    static navigationOptions = {
        drawerIcon: (
            <Image
                style={{ width: 25, height: 25 }}
                source={require('./../../../../../assets/images/americanfootball.png')}
            />
        )
    };
    constructor(props) {
    ...
    articlesByCategory(){
        this.props.getArticles(61).then(()=>{
...
function mapStateToProps(state){
    console.warn("***** AFB STATE TO PROPS:" + JSON.stringify(state))
    return {
...
export default connect(mapStateToProps, {clearArticles, getArticles})(AmericanFootballScreen);
