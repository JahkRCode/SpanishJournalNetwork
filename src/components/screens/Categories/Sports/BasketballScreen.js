...
class BasketballScreen extends Component{
    ...
    articlesByCategory(){
        this.props.getArticles(59).then(()=>{
...
function mapStateToProps(state){
    //console.warn("***** BkB STATE TO PROPS:" + JSON.stringify(state))
    return {
...
export default connect(mapStateToProps, {clearArticles, getArticles})(BasketballScreen);
