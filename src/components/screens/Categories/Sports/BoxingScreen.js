...
class BoxingScreen extends Component{
    ...
    articlesByCategory(){
        this.props.getArticles(63).then(()=>{
...
function mapStateToProps(state){
    //console.warn("***** BOX STATE TO PROPS:" + JSON.stringify(state))
    return {
...
export default connect(mapStateToProps, {clearArticles, getArticles})(BoxingScreen);
