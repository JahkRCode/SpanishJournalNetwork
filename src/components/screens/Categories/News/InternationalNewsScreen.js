...
class InternationalNewsScreen extends Component{
    ...
    articlesByCategory(){
        this.props.getArticles(10).then(()=>{
...
function mapStateToProps(state){
    //console.warn("***** IN STATE TO PROPS:" + JSON.stringify(state))
    return {
...
export default connect(mapStateToProps, {clearArticles, getArticles})(InternationalNewsScreen);
