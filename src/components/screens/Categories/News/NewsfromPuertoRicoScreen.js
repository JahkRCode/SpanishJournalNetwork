...
class NewsfromPuertoRicoScreen extends Component{
    static navigationOptions = {
        drawerIcon: (
            <Image
                style={{ width: 25, height: 25 }}
                source={require('./../../../../../assets/images/puertorico.png')}
            />
        )
    };
    constructor(props) {
...
function mapStateToProps(state){
    //console.log("***** NPR STATE TO PROPS:" + JSON.stringify(state))
    return {
...
export default connect(mapStateToProps, {clearArticles, getArticles})(NewsfromPuertoRicoScreen);
