...
class NationalNewsScreen extends Component{
    ...
    articlesByCategory(){
        this.props.getArticles(12).then(()=>{
...
function mapStateToProps(state){
    //console.warn("***** NN STATE TO PROPS:" + JSON.stringify(state))
    return {
...
export default connect(mapStateToProps, {clearArticles, getArticles})(NationalNewsScreen);
