...
class MusicScreen extends Component{
    ...
    articlesByCategory(){
        this.props.getArticles(26).then(()=>{
...
function mapStateToProps(state){
    //console.warn("***** MUS STATE TO PROPS:" + JSON.stringify(state))
    return {
...
export default connect(mapStateToProps, {clearArticles, getArticles})(MusicScreen);
