...
class SaludScreen extends Component{
    ...
    articlesByCategory(){
        this.props.getArticles(11).then(()=>{
...
function mapStateToProps(state){
    //console.warn("***** SAL STATE TO PROPS:" + JSON.stringify(state))
    return {
...
export default connect(mapStateToProps, {clearArticles, getArticles})(SaludScreen);
