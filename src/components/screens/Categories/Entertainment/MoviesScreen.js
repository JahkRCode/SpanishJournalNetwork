...
class MoviesScreen extends Component{
    ...
    articlesByCategory(){
        this.props.getArticles(25).then(()=>{
...
function mapStateToProps(state){
    //console.warn("***** MOV STATE TO PROPS:" + JSON.stringify(state))
    return {
...
export default connect(mapStateToProps, {clearArticles, getArticles})(MoviesScreen);
