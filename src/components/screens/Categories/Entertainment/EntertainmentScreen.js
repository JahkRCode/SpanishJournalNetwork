...
class EntertainmentScreen extends Component{
    ...
    articlesByCategory(){
        this.props.getArticles(13).then(()=>{
...
function mapStateToProps(state){
    //console.warn("***** ENT STATE TO PROPS:" + JSON.stringify(state))
    return {
...
export default connect(mapStateToProps, {clearArticles, getArticles})(EntertainmentScreen);
