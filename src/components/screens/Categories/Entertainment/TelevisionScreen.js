...
class TelevisionScreen extends Component{
    ...
    articlesByCategory(){
        this.props.getArticles(27).then(()=>{
...
function mapStateToProps(state){
    //console.warn("***** TEL STATE TO PROPS:" + JSON.stringify(state))
    return {
...
export default connect(mapStateToProps, {clearArticles, getArticles})(TelevisionScreen);
